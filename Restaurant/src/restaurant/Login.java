...
public class Login extends javax.swing.JFrame {
    ...
    if(user.equalsIgnoreCase(tf_username.getText()) 
        ...
        OO_Restaurant oo = new OO_Restaurant();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int closeselected = JOptionPane.showConfirmDialog(null, "Yakin Keluar "
                + "Dari Program?","Close Message", JOptionPane.YES_NO_OPTION);
        if(closeselected == JOptionPane.NO_OPTION){
            System.out.println("NO.. Option Selected..");
            }else if (closeselected == JOptionPane.YES_OPTION){
